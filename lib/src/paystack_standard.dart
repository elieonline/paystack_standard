...
import 'component/xdialog.dart';
import 'component/xwarning_dialog.dart';
import 'model/checkout_response.dart';

const paystackColor = Color(0xFF09A5DB);

class PaystackStandard extends StatefulWidget {
  final String checkoutUrl;

  const PaystackStandard({super.key, required this.checkoutUrl});

  @override
  State<StatefulWidget> createState() => _State();
}

class _State extends State<PaystackStandard> {
